...
>GitHub URL:https://Alice4ever@github.com
...
g_hist <- ggplot(county_df[!is.county.ok,]) +
...
With respect of contruction, poverty and professional, lower peninsula has a wider range of different levels over the counties than upper peninsula.The majotiy of upper peninsula has higher poverty level, less professional level and more construction.
...
>By examing the scatter plot of IncomePerCap and MeanCommute, we can see that the plotting does not show a very obvious uphill/downhill pattem from left to right. So the MeanCommute does not relate to IncomePerCap very much, longer MeanCommute time does not indicate a better IncomePerCap.By examing the plot size and color,we can see LP Peninsula has more TotalPop and people there has longer MeanCommute time and more IncomePerCap; On the other hand, Upper Peninsula's average commute time is less than 25min and IncomePerCap is less than $30000. Their population is smaller too.
...
```
> scatterplot 1: for Lower peninsula, scatterplots of MeanCommute and IncomePerCap still does not indicate a positive relationship between them, while for upper peninsula, it looks like with the increase of mean commute time, the income per cap increases(except some outliers.)
scatterplot 2: this plots showed a slight positive relationship between construction and meancommute in both peninsulas. It looks like upper peninsula has a relatively stronger correlation between these two variables.
Scatterplot 3 shows in  both peninsulas, a better professional level indicates a better income. Upper peninsular has a wider range of Income as well as Professioal level than lower peninsular.
Scatterplot 4 shows in  both peninsulas, a better professional level indicates less child poverty. Likewise, Upper peninsular has more varieties of child poverty  as well as Professioal level.
